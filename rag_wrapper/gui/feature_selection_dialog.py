...
def _make_checklist(feature_names, default_checked):
    ...
    return Checklist( 'root', Qt.Unchecked, feature_names, None )
...
if __name__ == "__main__":
    ...
    #channel_names = ['Grayscale', 'Membranes']
    #feature_names = ['standard_edge', 'geometry_edge', 'standard_node', 'geometry_node']

    #default_selections = { 'Grayscale': ['standard_edge', 'standard_node'],
    #                       'Membranes': ['standard_edge'] }
